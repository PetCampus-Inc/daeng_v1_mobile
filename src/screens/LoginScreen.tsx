  ...
  return (
    <View className="h-full px-4 bg-white">
      ...
      <View className="mt-[108]">
        <Text className="text-title-24-b text-foreground">
          <Text className="text-primary">우리 강아지</Text>의 유치원
        </Text>
        <Text className="text-title-24-b text-foreground">생활을 보러 갈까요?</Text>
      </View>
      ...
      <TouchableOpacity className="self-center px-4 py-3 mt-6">
        <Text className="text-label-14-b text-gray-1">서비스 체험하기</Text>
      </TouchableOpacity>
